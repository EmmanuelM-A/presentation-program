...
public enum GeneralButtons {
    ...
    SAVE_AS("Save As", "save-as.png", 32, 32, null),
    PRINT("Print", "printer.png", 32, 32, null),
    RECENTS("Recents", "", 32, 32, null),
    CLIPBOARD("Clipboard", "clipboard.png", 32, 32, null),
    SELECT("Select", "selection.png", 32, 32, null),
    PASTE("Paste", "paste.png", 32, 32, null),
    SETTINGS("Settings", "gear.png", 32, 32, null),
    SPELL_CHECKER("Spell Checker", "search.png", 32, 32, null),
    ...
    ADD_AUDIO("Audio", "add-audio.png", 32, 32, null),
