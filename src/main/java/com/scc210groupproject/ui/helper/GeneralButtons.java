...
public enum GeneralButtons {
    ...
    INSERT_SLIDE_BEFORE("Insert Slide Left", "insert-left.png", 32, 32, new InsertSlideBeforeAction()),
    INSERT_SLIDE_AFTER("Insert Slide Right", "insert-right.png", 32, 32, new InsertSlideAfterAction()),
    ...
    PIE("", "pie-chart.png", 32, 32, new NewChartTypeAction("PIE")),
    BAR("", "bar-chart.png", 32, 32, new NewChartTypeAction("BAR")),
    LINE("", "line-chart.png", 32, 32, new NewChartTypeAction("LINE")),
    SCATTER("", "scatter-chart.png", 32, 32, new NewChartTypeAction("SCATTER")),
    ...
    DELETE_SLIDE("Delete Slide", "delete-slide.png", 32, 32, new DeleteSlideAction()),
    ...
    TEXTCOLOUR("", "text-colour.png", 32, 32, new StyleAction("TEXTCOLOUR")),
    BACKGROUNDCOLOUR("", "background-colour.png", 32, 32, new StyleAction("BACKGROUNDCOLOUR")),
    TOGGLEARROWA("", "left-arrow.png", 32, 32, new ToggleAction("A")),
    TOGGLEARROWB("", "right-arrow.png", 32, 32, new ToggleAction("B")),
    TOGGLEDOTTED("", "dotted.png", 32, 32, new ToggleAction("DOTTED")),
    TOGGLESOLID("", "solid.png", 32, 32, new ToggleAction("SOLID")),
