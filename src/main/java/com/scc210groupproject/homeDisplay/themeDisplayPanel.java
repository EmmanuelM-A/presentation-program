...
import javax.swing.JPanel;
    ...
    public class themeDisplayPanel extends homeContentPanel{
            ...
            private String presetDirectory ="src/main/presets/themes";
            ...
            public themeDisplayPanel(){
                ...
                mainPanel.setLayout(new GridLayout(themeButtons.length/2,5));
                for(JButton button:themeButtons){ mainPanel.add(button);}
